	...
	config = function()
		...
		require("gruvbox").setup({
			overrides = {
				...
				CmpDocBorder = { fg = palette.yellow, bg = palette.dark2 },
				CmpDocNormal = { bg = palette.dark2 },
        NotifyError = { fg = palette.bright_red },
        NotifyERRORBorder = { fg = palette.bright_red },
        NotifyWarning = { fg = palette.bright_yellow },
        NotifyWARNBorder = { fg = palette.bright_yellow},
        NotifyInfo = { fg = palette.bright_blue },
        NotifyINFOBorder = { fg = palette.bright_blue },
        NotifyHint = { fg = palette.bright_green },
        NotifyHINTBorder = { fg = palette.bright_green },
			},
		})
	end,
}
